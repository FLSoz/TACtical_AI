...
namespace TAC_AI.AI.Enemy.EnemyOperations
{
    public static class RMiner
    {
        public static void MineYerOwnBusiness(AIECore.TankAIHelper thisInst, Tank tank, EnemyMind mind)
        {
            ...
            {
                thisInst.foundBase = AIECore.FetchClosestHarvestReceiver(tank.transform.position, tank.Radar.Range + 150, out thisInst.lastBasePos, out thisInst.theBase, tank.Team);
            ...
            else
            {
                ...
                hasMessaged = AIECore.AIMessage(hasMessaged, "TACtical_AI: AI " + tank.name + ":  Moving out to mine at " + thisInst.theResource.centrePosition);
